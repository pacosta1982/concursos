...
class FillPermissionsForLanguageLevelResume extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLanguageLevelResume constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.language-level-resume',
            'admin.language-level-resume.index',
            'admin.language-level-resume.create',
            'admin.language-level-resume.show',
            'admin.language-level-resume.edit',
            'admin.language-level-resume.delete',
            'admin.language-level-resume.bulk-delete',
        ]);
