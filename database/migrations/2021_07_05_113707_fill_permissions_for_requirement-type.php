...
class FillPermissionsForRequirementType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRequirementType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.requirement-type.index',
            'admin.requirement-type.create',
            'admin.requirement-type.show',
            'admin.requirement-type.edit',
            'admin.requirement-type.delete',
            'admin.requirement-type.bulk-delete',
        ]);
