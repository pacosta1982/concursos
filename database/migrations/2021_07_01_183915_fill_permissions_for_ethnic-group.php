...
class FillPermissionsForEthnicGroup extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEthnicGroup constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ethnic-group',
            'admin.ethnic-group.index',
            'admin.ethnic-group.create',
            'admin.ethnic-group.show',
            'admin.ethnic-group.edit',
            'admin.ethnic-group.delete',
            'admin.ethnic-group.bulk-delete',
        ]);
