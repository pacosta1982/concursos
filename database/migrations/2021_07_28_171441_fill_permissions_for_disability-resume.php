...
class FillPermissionsForDisabilityResume extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDisabilityResume constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.disability-resume',
            'admin.disability-resume.index',
            'admin.disability-resume.create',
            'admin.disability-resume.show',
            'admin.disability-resume.edit',
            'admin.disability-resume.delete',
            'admin.disability-resume.bulk-delete',
        ]);
