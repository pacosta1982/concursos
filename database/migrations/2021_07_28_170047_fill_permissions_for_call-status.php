...
class FillPermissionsForCallStatus extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCallStatus constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.call-status',
            'admin.call-status.index',
            'admin.call-status.create',
            'admin.call-status.show',
            'admin.call-status.edit',
            'admin.call-status.delete',
            'admin.call-status.bulk-delete',
        ]);
