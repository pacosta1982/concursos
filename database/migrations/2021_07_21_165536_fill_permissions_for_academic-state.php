...
class FillPermissionsForAcademicState extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAcademicState constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.academic-state',
            'admin.academic-state.index',
            'admin.academic-state.create',
            'admin.academic-state.show',
            'admin.academic-state.edit',
            'admin.academic-state.delete',
            'admin.academic-state.bulk-delete',
        ]);
