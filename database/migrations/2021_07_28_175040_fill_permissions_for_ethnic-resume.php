...
class FillPermissionsForEthnicResume extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEthnicResume constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ethnic-resume',
            'admin.ethnic-resume.index',
            'admin.ethnic-resume.create',
            'admin.ethnic-resume.show',
            'admin.ethnic-resume.edit',
            'admin.ethnic-resume.delete',
            'admin.ethnic-resume.bulk-delete',
        ]);
