...
class FillPermissionsForEndReason extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEndReason constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.end-reason',
            'admin.end-reason.index',
            'admin.end-reason.create',
            'admin.end-reason.show',
            'admin.end-reason.edit',
            'admin.end-reason.delete',
            'admin.end-reason.bulk-delete',
        ]);
