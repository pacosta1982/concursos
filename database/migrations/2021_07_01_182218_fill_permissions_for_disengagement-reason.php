...
class FillPermissionsForDisengagementReason extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDisengagementReason constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.disengagement-reason',
            'admin.disengagement-reason.index',
            'admin.disengagement-reason.create',
            'admin.disengagement-reason.show',
            'admin.disengagement-reason.edit',
            'admin.disengagement-reason.delete',
            'admin.disengagement-reason.bulk-delete',
        ]);
