...
class FillPermissionsForAcademicTraining extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAcademicTraining constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.academic-training',
            'admin.academic-training.index',
            'admin.academic-training.create',
            'admin.academic-training.show',
            'admin.academic-training.edit',
            'admin.academic-training.delete',
            'admin.academic-training.bulk-delete',
        ]);
