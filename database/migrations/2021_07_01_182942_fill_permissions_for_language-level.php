...
class FillPermissionsForLanguageLevel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLanguageLevel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.language-level',
            'admin.language-level.index',
            'admin.language-level.create',
            'admin.language-level.show',
            'admin.language-level.edit',
            'admin.language-level.delete',
            'admin.language-level.bulk-delete',
        ]);
