...
class FillPermissionsForCallType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCallType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.call-type',
            'admin.call-type.index',
            'admin.call-type.create',
            'admin.call-type.show',
            'admin.call-type.edit',
            'admin.call-type.delete',
            'admin.call-type.bulk-delete',
        ]);
