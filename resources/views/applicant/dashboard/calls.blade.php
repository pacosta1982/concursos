<call-listing :data="{{ $data->toJson() }}" :hoy="'{{ $hoy }}'" :url="'{{ url('admin/calls') }}'"
    inline-template>
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'description'">
                                        {{ trans('admin.call.columns.description') }}</th>
                                    <th is='sortable' :column="'call_type_id'">
                                        {{ trans('admin.call.columns.call_type_id') }}</th>
                                    <th is='sortable' :column="'position_id'">
                                        {{ trans('admin.call.columns.position_id') }}</th>
                                    <th is='sortable' :column="'company_id'">
                                        {{ trans('admin.call.columns.company_id') }}</th>
                                    <th is='sortable' :column="'start'">{{ trans('admin.call.columns.start') }}
                                    </th>
                                    <th is='sortable' :column="'end'">{{ trans('admin.call.columns.end') }}
                                    </th>
                                        ...
                                        <div class="row no-gutters">
                                            <div class="col-auto">
                                                <a class="btn btn-sm btn-spinner btn-info"
                                                    :href="item.is_admin + '/show'"
                                                    title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                    role="button"><i class="fa fa-search"></i></a>
                                            </div>
                                            <div class="col-auto"
                                                v-if="item.start <= '{{ $hoy }}' && item.end >= '{{ $hoy }}'">
                                                <a class="btn btn-sm btn-spinner btn-success"
                                                    :href="item.is_admin + '/application'"
                                                    title="{{ trans('brackets/admin-ui::admin.btn.show') }}"
                                                    role="button"><i class="fa fa-check-square"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
