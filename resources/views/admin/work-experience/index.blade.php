...
@section('title', trans('admin.work-experience.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/work-experiences/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.work-experience.actions.create') }}</a>
                    </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.work-experience.columns.id') }}</th>
                                        <th is='sortable' :column="'resume_id'">{{ trans('admin.work-experience.columns.resume_id') }}</th>
