...
@section('title', trans('admin.language-level-resume.actions.index'))
            ...
            <div class="col">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-primary btn-spinner btn-sm pull-right m-b-0" href="{{ url('admin/language-level-resumes/create') }}" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.language-level-resume.actions.create') }}</a>
                    </div>
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'id'">{{ trans('admin.language-level-resume.columns.id') }}</th>
                                        <th is='sortable' :column="'resume_id'">{{ trans('admin.language-level-resume.columns.resume_id') }}</th>
